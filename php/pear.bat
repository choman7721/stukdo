@ECHO OFF                                                                                                     
									SET "PHP_PEAR_SYSCONF_DIR=H:\Rails\php"
...
FOR %%x IN ("H:\Rails\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=H:\Rails\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=H:\Rails\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=H:\Rails\php\php.exe"
